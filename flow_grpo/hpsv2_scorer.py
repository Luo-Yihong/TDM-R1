...
class HPSv2Scorer(nn.Module):
    def __init__(self, dtype, device):
        ...
        model = create_model(
            "ViT-H-14",
            os.path.join(CKPT_PATH, "CLIP-ViT-H-14-laion2B-s32B-b79K", "open_clip_pytorch_model.bin"),
            precision="amp",
            device=device,
            jit=False,
        ...
        checkpoint = torch.load(os.path.join(CKPT_PATH, "HPSv2", "HPS_v2.1_compressed.pt"), map_location="cpu")
