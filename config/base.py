...
def get_config():
    ...
    pretrained.model = "/root/models/stable-diffusion-3.5-medium"
    ...
    # kl ratio
    train.beta = 0.0
    # pretrained lora path (empty string = disabled; use "" not None so
    # ml_collections.config_flags can override it from the CLI, since it
    # cannot infer a target type from None).
    train.lora_path = ""
    # save ema model
    train.ema = False
